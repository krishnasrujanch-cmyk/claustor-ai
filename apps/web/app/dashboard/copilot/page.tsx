...
export default function CopilotPage() {
  ...
  useEffect(() => {
    contractsAPI
      .list({ status: "analyzed", page_size: 50 })
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev.slice(0, -1),
        {
          role: "assistant",
          content:
            "Sorry, I couldn't process that query. Please try again.",
        },
      ]);
    } finally {
      setIsLoading(false);
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: C.muted }}>
            Ask anything about your contracts. Answers are cited from the actual document.
          </p>
        </div>
      ...
      >
        {messages.length === 0 && (
          <div style={{ textAlign: "center", paddingTop: 60 }}>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 700, color: C.heading, marginBottom: 8 }}>
              Ask your contracts anything
            </h2>
            <p style={{ fontSize: 14, color: C.muted, marginBottom: 32 }}>
              {selectedContract
                ? "Ask about the selected contract"
                : "Select a contract or ask across all contracts"}
            </p>
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: "12px 20px",
              background: isLoading || !input.trim() ? "#D1D5DB" : C.primary,
              color: "white",
              border: "none",
              borderRadius: 10,
              fontSize: 14,
        ...
        <p style={{ fontSize: 11, color: C.muted, marginTop: 8 }}>
          Answers are cited from your contracts. Not legal advice.
        </p>
      </div>
