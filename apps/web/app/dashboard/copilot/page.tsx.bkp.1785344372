          ...
          return (
            <div key={li} style={{display:"flex",gap:10,marginBottom:10,alignItems:"flex-start"}}>
              ...
              <div style={{flex:1,background:C.bg,border:`1px solid ${riskColor||C.border}`,
                ...
                <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:rest?4:0,flexWrap:"wrap"}}>
                  <span style={{fontSize:13,fontWeight:700,color:C.heading,marginRight:2}}>{inlineParse(title,citations)}</span>
                  <span style={{fontSize:10,fontWeight:700,padding:"2px 8px",borderRadius:20,
                    background:riskBg,color:riskColor,border:`1px solid ${riskColor}30`,
